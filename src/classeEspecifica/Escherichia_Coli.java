...
public class Escherichia_Coli extends Bacteria {
    ...
    public void atacar(Paciente paciente, LinkedList<AgentePatologico> listaDeAgentes) {
        ...
        if (this.getEnergiaVital() <= 0) {
            ...
            System.out.println(listaDeAgentes.size());
            ...
            AgentePatologico filha1 = new Escherichia_Coli(this.getIdentificacao()+"child-1");
            filha1.setEnergiaVital(this.getEnergiaVital() / 2);
            AgentePatologico filha2 = new Escherichia_Coli(this.getIdentificacao()+"child-2");
